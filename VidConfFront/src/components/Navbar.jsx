...
const Navbar = () => {
  ...
  return (
    <header className="flex h-20 w-full shrink-0 justify-between items-center px-4 md:px-6">
      <Link to={isLoggedIn ? `/dashboard` : `/`} className="mr-6 flex gap-2">
        <svg
          className="h-6 w-6"
        ...
        <span>VidConf Inc</span>
      </Link>

      <div className="lg:hidden items-center flex flex-row gap-4">
        <DarkMode />
        <Sheet>
          ...
          <SheetContent side="left">
            ...
            >
              ...
              <span className="sr-only">VidConf Inc</span>
            </Link>
            {isLoggedIn ? (
