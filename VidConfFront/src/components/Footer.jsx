...
const socialLinks = [
  ...
  },
  {
    ariaLabel: "Instagram",
    iconPath:
      "M20.145 11.892a1 1 0 110-2 1 1 0 010 2zm-4.145 8.108c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm0-6c-1.103 0-2 .897-2 2s.897 2 2 2 2-.897 2-2-.897-2-2-2zm4 10h-8c-2.056 0-4-1.944-4-4v-8c0-2.056 1.944-4 4-4h8c2.056 0 4 1.944 4 4v8c0 2.056-1.944 4-4 4zm-8-14c-.935 0-2 1.065-2 2v8c0 .953 1.047 2 2 2h8c.935 0 2-1.065 2-2v-8c0-.935-1.065-2-2-2h-8z",
    url: "#0",
  },
  {
    ariaLabel: "Linkedin",
  ...
  return (
    <footer className="relative">
      <div className="max-w-7xl px-6 mx-auto md:px-4">
        <div className="cq8p6 border-gray-300 md:py-16 border-t mt-[-1px] py-12">
          {/* Footer illustration */}
          <div aria-hidden="true" className="pointer-events-none z-[-1]">
            <svg
              className="transform -translate-x-1/2 cimtg absolute bottom-0 left-0 ml-24"
              fill="none"
              height="264"
              width="800"
          ...
          <div className="flex justify-between items-center">
            ...
            {/* Middle links */}
            <div className="c91hr order-1 mb-0 ceng1 md:mb-2">
              <Link
                className="text-gray-600 c0atf csz0f duration-150 ease-in-out transition"
                to="/terms"
              >
                Terms
              </Link>
