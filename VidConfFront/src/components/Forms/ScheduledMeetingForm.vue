  ...
  <div>
    <Dialog v-model:open="open">
      <DialogTrigger as-child>
        <Button> <CalendarPlus class="mr-2 h-4 w-4" /> Create Meeting </Button>
      </DialogTrigger>
      <DialogContent
        class="w-auto"
        :class="isChecked ? `md:min-w-[40rem]` : ``"
      >
        <DialogHeader class="space-y-1">
          <DialogTitle class="text-2xl">Create a Meeting</DialogTitle>
          <DialogDescription
            >note meetings only last for an hour</DialogDescription
          >
        </DialogHeader>
